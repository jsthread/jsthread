...
_addTest = eval("0, " + _addTest);


var run_aux = eval(Thread.prepare(run));

run = function ( ) {
    Thread.create(run_aux);
}


Simple.prototype.run = eval(Thread.prepare(Simple.prototype.run));
