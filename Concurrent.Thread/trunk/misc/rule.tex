...
=  &  $ \Cs{ \var{e}; }{(l  , \set{}, t_1, \map{}, \map{}, r, x, s)}          $ \\
   ...
   &  $ \Bcond{ \Stack{\var{s'}} < \Stack{\var{s}}.length, t_4 }{(t_3, n, x)} $ \\
...
=  &  $ \Bcond{ true, \var{b}\map{\var{label}} }{(l, n, x)}    $
\end{tabular}
...
=  &  $ \Bcond{ true, \var{c}\map{\var{label}} }{(l, n, x)}    $
\end{tabular}
...
=  &  $ \Cs{ \var{s_1} }{(l, \set{}, n', b', c', r_1, x_1, s)} $ \\
   ...
   &  $ \Bcond{true, \Stack{s'}}{(t_3, \Stack{s'}, x)}        $  \\
