...
//@export AtomicBlock
function AtomicBlock ( labels, body, lineno, source ) {
    return Block.apply(this, arguments);
}

var proto = AtomicBlock.prototype = new Block();
proto.constructor = AtomicBlock;

proto.toString = function ( ) {
    var buf = [labelsToString.call(this), "atomic{"];
    this.body.forEach(function( it ){
        buf.push(it);
    });
    buf.push("}");
