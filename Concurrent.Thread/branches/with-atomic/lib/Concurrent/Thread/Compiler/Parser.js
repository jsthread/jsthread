...
// Exception to return atomic-block
var AtomicBlockException = {};
    ...
    switch ( this.peekToken() ) {
      ...
      case Token.NAME: {
        ...
        try {
            ...
            } else if ( e === AtomicBlockException ) {
                // Found atomic block!
                var lineno = this.ts.getLineno();
                var block = new AtomicBlock(labels, this.statements(), lineno, this.source);
                this.mustMatchToken(Token.RC, "msg.no.brace.block");
                return block;
            } else {
                throw e;
    ...
    switch ( tt ) {
      ...
      case Token.NAME:
        ...
        if ( ttFlagged & TI_CHECK_LABEL ) {
            ...
            if ( this.matchToken(Token.LC) ) throw AtomicBlockException;
        }
        return name;
